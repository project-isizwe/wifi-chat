define(function(require) {
    ...
    var _              = require('underscore')
      ...
      , Topics         = require('app/collections/UserPosts')
      , TopicItemView  = require('app/views/Activity/PostItem')
      , log            = require('bows.min')('Views:Channel:PostList')
    require('jquery.scrollparent')

    return Base.extend({

      template: _.template(require('text!tpl/Activity/PostList.html')),
